...
export default class Say2Essence extends GameServerPacket {
  ...
  static readonly PETITION_PLAYER: number = 6;
  static readonly PETITION_GM: number = 7;
  ...
  static readonly PARTYROOM_COMMANDER: number = 15;
  static readonly PARTYROOM_ALL: number = 16;
